            ...
            <main>
                <section class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <p class="font-semibold {{ $daysRemaining > 0 ? 'text-indigo-600' : 'text-red-600' }}"></p>
                ...
                <section class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <article class="bg-white p-6 rounded-lg border border-gray-100 shadow-sm flex flex-col">
                    ...
                    @else
                    <div class="bg-white p-6 rounded-lg border border-gray-100 shadow-sm text-center text-gray-500">
                ...
                <section class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white p-6 rounded-lg border border-gray-100 shadow-sm flex flex-col">
                    ...
                    @if($availableTools->count() > 0)
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            @foreach($availableTools as $tool)
                                ...
                                <div class="bg-white p-5 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200">
