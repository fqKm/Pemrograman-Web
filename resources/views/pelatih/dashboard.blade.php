        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="space-y-8">
                ...
                <div class="relative rounded-lg overflow-hidden shadow-lg">
                    ...
                    <div
                        class="absolute inset-0 bg-black bg-opacity-100 flex flex-col justify-center items-center text-center p-6">
                        <h1 class="text-10xl font-bold text-black mb-2">Selamat Datang {{$pelatih->nama_pelatih}}</h1>
                        <p class="text-lg text-gray-200">Manage your classes, track student progress, and organize
                            workout plans</p>
                    </div>
                </div>
                ...
                <section>
                    <h2 class="text-2xl font-semibold text-gray-900 mb-4">Your Class</h2>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        @forelse($kelas as $kelas_data)
                            <article class="bg-white p-6 rounded-lg shadow-sm flex flex-col">
                                ...
                                <span></span>
                                <h3 class="text-lg font-semibol"> Jumlah Member Bergabung
                        ...
                        <section>
                            <h2 class="text-2xl font-semibold text-gray-900 mb-4">Your Students</h2>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">

                                @forelse($members as $member)
                                    <article class="bg-white rounded-lg shadow-sm overflow-hidden pb-12">
