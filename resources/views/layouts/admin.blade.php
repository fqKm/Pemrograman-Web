...
<head>
    ...
    <title>{{ config('app.name', 'FitHub Gym') }} - Admin</title>
    ...
    <nav class="fixed w-full z-50 bg-white/90 backdrop-blur-sm border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="{{ route('pelatih.index') }}" class="nav-link">Pelatih</a>
                <a href="{{ route('membership.index') }}" class="nav-link">Membership</a>
                <a href="{{ route('alat.index') }}" class="nav-link">Alat</a>
            </div>
            ...
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        ...
                        <li><a href="{{ route('member.index') }}" class="hover:text-white">Member</a></li>
                        <li><a href="{{ route('kelas.index') }}" class="hover:text-white">Kelas</a></li>
                        <li><a href="{{ route('pelatih.index') }}" class="hover:text-white">Pelatih</a></li>
                        <li><a href="{{ route('membership.index') }}" class="hover:text-white">Membership</a></li>
                        <li><a href="{{ route('alat.index') }}" class="hover:text-white">Alat</a></li>
                    </ul>
                </div>
                <div>
