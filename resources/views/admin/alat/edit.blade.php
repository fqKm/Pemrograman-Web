<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-2xl font-semibold text-gray-800 mb-4 dark:text-white">Edit Data Alat</h1>
                ...
                <div class="p-6">
                    <form action="{{ route('alat.update', $alat->id) }}" method="POST">
                        ...
                        <div class="flex items-center justify-end mt-6">
                            ...
                            <button  class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">Simpan</button>
                        </div>
                    </form>
                </div>
            </div>
